...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url() ?>template/index2.html" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><font size="2">BNHA</font></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><font size="3"><b>Sara ni Mukou e... </b></font></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url() ?>template/dist/img/aki-kun.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">RaidShadowFox</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  RaidShadowFox - Don't Ask
                  <small>Look, people are like...</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
